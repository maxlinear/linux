...
/*GSWIP 3.2 --------------------------*/
#define PBBTNLTEMPLATE_TABLE_SIZE           256
/*-------------------------------------*/
...
#define PCE_OAM_LOSS_SIZE	16
#define PCE_OAM_DELAY_SIZE	16
#define PCE_OAM_COMP_SIZE	4
...
#define LTQ_GSWIP_2_0		0x0001
#define LTQ_GSWIP_2_1		0x2100
#define LTQ_GSWIP_2_2		0x2201
#define LTQ_GSWIP_2_2_ETC	0x2300
#define LTQ_GSWIP_3_0		0x3000
#define LTQ_GSWIP_3_1		0x3100
#define LTQ_GSWIP_3_2		0x3200
#define LTQ_GSWIP_3_2B		0x3201

/*Applicable only for GSWIP 3.2*/
#define RMON_COUNTER_OFFSET_GSWIP3_2 27
#define GSW_BRIDGE_PORT_SRC_IP_LOOKUP_DISABLE 1

#define VRSN_REV(ver)	((ver) & 0xFF00)
#define VRSN_CMP(x, y)	((int)(x) - (int)(y))

#define IS_VRSN_32(ver) \
	(VRSN_REV(ver) == LTQ_GSWIP_3_2)
...
enum {
	...
	FLAG_L2TP,
	FLAG_GRE_VLAN1,
	FLAG_2_1VLAN = FLAG_GRE_VLAN1,
	FLAG_GRE_VLAN2,
	FLAG_2_2VLAN = FLAG_GRE_VLAN2,
	FLAG_GRE_PPPOE,
	FLAG_IPV4MC,
	FLAG_PBB = FLAG_IPV4MC,
	FLAG_ETYPE_888E,
	FLAG_ICMPV6,
	FLAG_NN16,
	FLAG_NN17, /* 40 */
...
typedef pce_uc_row_t PCE_MICROCODE[];
...
typedef struct {
	...
	u16 oam_loss_cnt[PCE_OAM_LOSS_SIZE];
	u16 oam_delay_cnt[PCE_OAM_DELAY_SIZE];
	u8 oam_comp_cnt[PCE_OAM_COMP_SIZE];
...
/* CTP counter update for overflow handling */
typedef struct {
	u64 nRxPkts;
	u64 nRxDrops;
	u64 nRxErrors;
...
typedef struct {
	...
	u16 max_ctp;
	gsw_ctp_cnt_t *cnt;
	struct delayed_work cnt_update_work;
} gsw_ctp_cnt_info_t;
...
typedef struct {
	...
	gsw_tunneltemplate_t tunnelTemplate_idx[PBBTNLTEMPLATE_TABLE_SIZE];
	void *raldev;
	...
	u16 num_of_pbbtunnel;		/*Number of PBB tunnel tempate Index - applicable for 3.2 */
	u16 num_of_globalport;		/*Number of global port - applicable for 3.2 */
	...
	u32 gsw_mode;			/* GSWIP Mode Bit 0 - 0 "short_cut", 1 "full_qos" */
	struct gsw_lpid_epg_map_s lpid_epg_map[LPID_COUNT];
					/*            Bit 1 - 0 "default", 1 "LPID Port Mode 1" */
	...
	u32 pmac_fcs_enable; /* Configure FCSEN in PMAC. Bit 0: PMAC0, Bit 1: PMAC1, Bit 2: PMAC2 */
