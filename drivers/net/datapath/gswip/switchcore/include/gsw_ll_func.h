...
/**
   ...
   - An error code in case an error occurs
*/
GSW_return_t GSW_MacsecCfg(void *cdev, GSW_MACSec_cfg_t *parm);

/**
   This is the switch API low-level function for
   the GSW_PMACBR_CFG command.
   ...
   - An error code in case an error occurs
*/
GSW_return_t GSW_PmacbrCfg(void *cdev, GSW_MAC_cfg_t *parm);
...
GSW_return_t GSW_Debug_TunnelTemplateTableStatus(void *cdev, GSW_debug_t *parm);
