...
#define MAX_SHARED_BW_GRP     (511)
#define NO_SHARED_BW_GRP      (0x0)
#define SCHED_REP_BW          (80) /* min bw, using in shared bwl group */
...
/* using for McDMA and for the POP decriptor - debug */
#define PPV4_QOS_DMA_BUFF_SIZE 4096

#define QOS_FIRMWARE_FILE "ppv4-qos-fw.elf"
#define QOS_ELF_FW_IMAGE_SZ 0x30000
 ...
 * Fat table stuff
 */
#define FW_FAT_TBL_SIZE   16
#define FW_FAT_ENT_WIN_SZ ((1 << 28) - 1)
...
#define QOS_BW_GRP_VALID(id)   ((id) && ((id) <= MAX_SHARED_BW_GRP))

#define QOS_MODIFIED_NODE_TYPE                   BIT_ULL(0)
#define QOS_MODIFIED_BANDWIDTH_LIMIT             BIT_ULL(1)
#define QOS_MODIFIED_SHARED_GROUP_ID             BIT_ULL(2)
#define QOS_MODIFIED_ARBITRATION                 BIT_ULL(3)
#define QOS_MODIFIED_BEST_EFFORT                 BIT_ULL(4)
#define QOS_MODIFIED_PRIORITY                    BIT_ULL(5)
#define QOS_MODIFIED_BW_WEIGHT                   BIT_ULL(6)
#define QOS_MODIFIED_PARENT                      BIT_ULL(7)
#define QOS_MODIFIED_RING_ADDRESS                BIT_ULL(8)
#define QOS_MODIFIED_RING_SIZE                   BIT_ULL(9)
#define QOS_MODIFIED_CREDIT                      BIT_ULL(10)
#define QOS_MODIFIED_DISABLE                     BIT_ULL(11)
#define QOS_MODIFIED_MAX_BURST                   BIT_ULL(12)
#define QOS_MODIFIED_BLOCKED                     BIT_ULL(13)
#define QOS_MODIFIED_WRED_ENABLE                 BIT_ULL(14)
#define QOS_MODIFIED_WRED_MIN_GREEN              BIT_ULL(15)
#define QOS_MODIFIED_WRED_MAX_GREEN              BIT_ULL(16)
#define QOS_MODIFIED_WRED_SLOPE_GREEN            BIT_ULL(17)
#define QOS_MODIFIED_WRED_MIN_YELLOW             BIT_ULL(18)
#define QOS_MODIFIED_WRED_MAX_YELLOW             BIT_ULL(19)
#define QOS_MODIFIED_WRED_SLOPE_YELLOW           BIT_ULL(20)
#define QOS_MODIFIED_WRED_MAX_ALLOWED            BIT_ULL(21)
#define QOS_MODIFIED_WRED_MIN_GUARANTEED         BIT_ULL(22)
#define QOS_MODIFIED_RLM                         BIT_ULL(23)
#define QOS_MODIFIED_WRED_FIXED_DROP_PROB_ENABLE BIT_ULL(24)
#define QOS_MODIFIED_WRED_FIXED_GREEN_PROB       BIT_ULL(25)
#define QOS_MODIFIED_WRED_FIXED_YELLOW_PROB      BIT_ULL(26)
#define QOS_MODIFIED_QUEUE_PORT                  BIT_ULL(27)
#define QOS_MODIFIED_CODEL                       BIT_ULL(28)
#define QOS_MODIFIED_PORT_GREEN_THRESHOLD        BIT_ULL(29)
#define QOS_MODIFIED_PORT_YELLOW_THRESHOLD       BIT_ULL(30)
#define QOS_MODIFIED_PORT_ENHANCED_WSP           BIT_ULL(31)
#define QOS_MODIFIED_FAST_Q                      BIT_ULL(32)
...
#define UC_MSC_CLK_REQ0_LEN      1
#define UC_MSC_CLK_REQ0_MSK      0x1
#define UC_MSC_CLK_REQ1_OFF      1
#define UC_MSC_CLK_REQ1_LEN      1
#define UC_MSC_CLK_REQ1_MSK      0x2
#define UC_MSC_CLK_REQ2_OFF      2
#define UC_MSC_CLK_REQ2_LEN      1
#define UC_MSC_CLK_REQ2_MSK      0x4
#define UC_MSC_CLK_REQ3_OFF      3
#define UC_MSC_CLK_REQ3_LEN      1
#define UC_MSC_CLK_REQ3_MSK      0x8
#define UC_MSC_CLK_REQ4_OFF      4
#define UC_MSC_CLK_REQ4_LEN      1
#define UC_MSC_CLK_REQ4_MSK      0x10
#define UC_MSC_HW_DFS_LVL_OFF    16
#define UC_MSC_HW_DFS_LVL_LEN    3
#define UC_MSC_HW_DFS_LVL_MSK    0x70000
#define UC_MSC_UC_DFS_LVL_OFF    19
#define UC_MSC_UC_DFS_LVL_LEN    3
#define UC_MSC_UC_DFS_LVL_MSK    0x380000
#define UC_MSC_TBM_DFS_LVL_OFF    22
#define UC_MSC_TBM_DFS_LVL_LEN    3
#define UC_MSC_TBM_DFS_LVL_MSK    0x1C00000
 ...
 */
struct fw_com {
	u64         cmdbuf;	/* host address */
	size_t      cmdbuf_sz;	/* cmd buffer size */
	u64         mbx_to_uc;
	u64         rspbuf;	/* host address */
	size_t      rspbuf_sz;	/* size of buffer */
	u64         gaurd;	/* Guard address */
	debug_counters_t *dbg_cnt; /* debug counters */
	wred_aqm_db_t *aqm_db; /* aqm DB */
	bool wait_on_complete;
	bool        clear_bwl_db;
	u32         wait_for_answer;
};
 ...
 * @qos_uc_misc           UC misc registers base address
...
#define NODE_FLAGS_USED                  BIT_ULL(0) /* Active node */
#define NODE_FLAGS_INTERNAL              BIT_ULL(1) /* Internal node */
#define NODE_FLAGS_QUEUE_NEW_SYNCQ       BIT_ULL(2) /* SQ allocated */
#define NODE_FLAGS_QUEUE_CONNECTED_SYNCQ BIT_ULL(3) /* SQ connected to tree */
#define NODE_FLAGS_PARENT_BEST_EFFORT_EN BIT_ULL(4) /* Best effort */
#define NODE_FLAGS_REPLICATION_NODE      BIT_ULL(5) /* Dual rate shaper replica */
#define NODE_FLAGS_SCHED_SYNCQ           BIT_ULL(6) /* Sched for SQ */
#define NODE_FLAGS_PORT_PACKET_CREDIT_EN BIT_ULL(7) /* Packet credit mode */
#define NODE_FLAGS_PORT_BYTE_CREDIT_EN   BIT_ULL(8) /* Byte credit - DEPRECATED */
#define NODE_FLAGS_QUEUE_WRED_EN         BIT_ULL(10) /* WRED algorithm enabled */
#define NODE_FLAGS_QUEUE_BLOCKED         BIT_ULL(11) /* Queue is blocked */
#define NODE_FLAGS_QUEUE_WRED_FIXED_DROP_PROB_EN BIT_ULL(12) /* Fixed drop prob */
#define NODE_FLAGS_QUEUE_AQM             BIT_ULL(13) /* Connected to AQM context */
#define NODE_FLAGS_ENHANCED_WSP          BIT_ULL(14) /* Enhanced WSP Port */
	u16 flags;
};
...
struct hw_mem {
	...
	/* all fw/driver shared memories */
	void         *fw_ddr_virt;
	dma_addr_t   fw_ddr_phys;
	size_t       fw_ddr_sz;
...
struct pp_qos_dev {
	...
	u32                            id;
	bool                           initialized;
	struct wsp_info                ewsp_db;
	struct pp_qos_init_param       init_params;
	struct shared_bw_group         groups[MAX_SHARED_BW_GRP + 1];
	struct pp_pool                 *ids;
	struct pp_pool                 *rlms;
	...
	struct hw_mem                  hwmem;
	void                           *fw_txt_virt;
	dma_addr_t                     fw_txt_phys;
	u8                             fw_fat[FW_FAT_TBL_SIZE];
	ulong                          fw_fat_bmap[BITS_TO_LONGS(FW_FAT_TBL_SIZE)];
	void                           *api_str_buf;
	u16                            *rlms_container;
	u32                            max_bw_limit_kbps; /* @todo remove WA */
#define PP_QOS_FLAGS_ASSERT        (0x1U)
	u32                            dbg_flags;
	struct dentry                  *dbgfs;
	struct kobject                 *sysfs;
	u16                            num_fast_queues;
	struct pp_qos_codel_cfg        codel_cfg;
};
...
/**
 * @brief Test wheather a node was already configured, it actually,
 *        checks if the node has physical id allocated as well
 * @param qdev
 * @param id node id
 * @param configured pointer to return an answer
 * @return s32 0 on success, error code in case the @id is no valid
 */
...
/**
 * @brief Update the QoS on clock rate change
 * @note This doesn't change the clock, but ONLY update the
...
/**
 * @brief Get current DFS level from HW
 * @return u32 the dfs level
 */
 ...
 * @return 0 on success
 */
s32 qos_shared_limit_group_add(struct pp_qos_dev *qos_dev, u32 max_burst,
			       u32 *id);
 ...
 * @return 0 on success
 */
s32 qos_shared_limit_group_remove(struct pp_qos_dev *qos_dev, u32 id);
 ...
 * @return 0 on success
 */
s32 qos_shared_limit_group_modify(struct pp_qos_dev *qos_dev, u32 id,
				  u32 max_burst);
 ...
 * @return 0 on success
 */
s32 qos_shared_limit_group_get_members(struct pp_qos_dev *qos_dev, u32 id,
				       uint16_t *members, u32 size,
				       u32 *members_num);

s32 _qos_shared_limit_group_add(struct pp_qos_dev *qos_dev, u32 max_burst,
			        u32 *id);
s32 _qos_shared_limit_group_remove(struct pp_qos_dev *qos_dev, u32 id);
s32 _qos_shared_limit_group_modify(struct pp_qos_dev *qos_dev, u32 id,
				   u32 max_burst);
