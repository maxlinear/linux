...
/* IP select stuff */
#define IP_SELECT_NEXT_HDR_OFF 0
...
#define L2TPV2_LEN_PRESENT     0x40  // (MSB) |T|L|x|x|S|x|O|P|	-> 0100 0000
#define L2TPV2_NO_LEN_PRESENT  0x00  // (MSB) |T|L|x|x|S|x|O|P|	-> 0000 0000
...
/* L2TPv3 stuff */
#define L2TPV3_VER             3
#define L2TPV3_OIP_HDR_LEN     8 /* no cookie allowed but l2-specific must exist */
#define L2TPV3_OIP_SESS_OFF    0
#define L2TPV3_OUDP_HDR_SIZE   12 /* no cookie allowed but l2-specific must exist */
#define L2TPV3_OUDP_SESS_OFF   4
#define L2TPV3_SESS_LEN        4
