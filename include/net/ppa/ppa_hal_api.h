...
#ifndef __PPA_HAL_API_H__
#define __PPA_HAL_API_H__
/*******************************************************************************
 **
...
typedef enum {
	PPA_GENERIC_WAN_INFO = 0,   /*get wan information*/
	...
	PPA_GENERIC_HAL_ADD_IF,
	PPA_GENERIC_HAL_DEL_IF,
	PPA_GENERIC_HAL_GET_STATS,
	/*make sure it is the last one */
